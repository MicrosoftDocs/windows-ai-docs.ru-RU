...
- Расширение генератора кода Windows машины обучения для [Visual Studio 2019](https://marketplace.visualstudio.com/items?itemName=WinML.MLGenV2) или [2017 г.](https://marketplace.visualstudio.com/items?itemName=WinML.mlgen)
